...
/**
    ...
    Объясните, почему объект user изменяется после вызова функции updateUserInfo, хотя ожидалось,
    что функция должна возвращать новый объект, не изменяя исходный.
